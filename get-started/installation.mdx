...
<Steps>
  ...
  <Step title="Create a Database">
    ...
    3. Under **Create New Database**, enter a name for your database (note the database name).
  ...
  <Step title="Create a Database User">
    ...
    2. Under **Add New User**, enter a username and password (note the database username and password).
...
Follow these steps to install Pocket Script on your main domain in cPanel:
...
- Upon successful installation, you need to remove/rename the install folder.
...
2. Explore [Website Basics](/website-basics/essentials) to learn about key Pocket Script features.
3. Consider setting up [email](/email/mailer) for smooth communication with your users.
