...
## Getting Google Client ID and Secret
  ...
  7. From the **Application type**, select the `Web application`, enter **Authorized JavaScript origins** and click **Create** button
      1. Authorized JavaScript origins
          ...
          - In case of a subdomain, enter your URL as: `https://subdomain.example.com`

      2. Authorized redirect URIs
          <Warning>For Authorized redirect URIs, append `admin/controller/oauth.php` to your website URL</Warning>
          - For the main domain install at `example.com`, enter your URL as: ```https://example.com/admin/controller/oauth.php```
          - For sub-domain install at `subdomain.example.com`, enter your URL as ```https://subdomain.example.com/controller/oauth.php```
          - For subfolder install at `example.com/subfolder,` enter your URL as  ```https://example.com/subfolder/controller/oauth.php```
